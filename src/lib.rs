use {
    field_attribute_layout::AttributeLayout,
    proc_macro2::TokenStream as TokenStream2,
    proc_macro::TokenStream,
    proc_macro_error::{abort_call_site, proc_macro_error, ResultExt},
    quote::quote,
    syn::{
        Data,
        DataStruct,
...
pub fn derive_getset(input: TokenStream) -> TokenStream
{
    ...
    for (idx, field) in fields.iter().enumerate()
    {
        ...
        let ident_or_index = field_ident.as_ref()
        ...
        for attr in getset_attrs
        {
            ...
            let fn_def = AttributeLayout::from(metas)
